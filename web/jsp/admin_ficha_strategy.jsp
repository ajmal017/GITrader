...
<script src="<%=request.getContextPath()%>/js/strategies.js"></script>
...
if (request.getParameter("wp")!=null) {  %>
	<link  rel="stylesheet" type="text/css"  href="<%=request.getContextPath()%>/css/popups.css"></link>
<% } %>
...
<div id="wrapper">
 ...
 <div id="content">
	...
	<div class="column12">		
	<jsp:include page="admin/ficha_estrategia.jsp"/>	
	</div>
