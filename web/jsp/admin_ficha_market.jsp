...
<script src="<%=request.getContextPath()%>/js/globalize.js"></script>
<script src="<%=request.getContextPath()%>/js/jquery.ui.timepicker.js"></script>
...
<link  rel="stylesheet" type="text/css"  href="<%=request.getContextPath()%>/css/jquery.ui.timepicker.css"></link>
</head>
<body>
<div id="wrapper">
 ...
 <div id="content">
	...
	<div class="column12">		
	<jsp:include page="admin/market/ficha_market.jsp"/>	
	</div>
