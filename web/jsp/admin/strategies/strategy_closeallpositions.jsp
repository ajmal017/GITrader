...
if (request.getParameter("pos_id_action")!=null) {  // hay operacion
	...
	Long  _MinutosAlCierre = Long.parseLong(request.getParameter("min_to_close"));
	...
	{	
		...
		oStrategyDATA.setSell_all_deadline_min_toclose(_MinutosAlCierre.intValue());
...
%>
    		...
    		<div>
    			<label class="flota_izq w200px textleft negrita" for="min_to_close">Minutos al cierre de mercado*</label> 
    			<input class="position fondo_blanco mandatory entero flota_izq" type="text" id="min_to_close" name="min_to_close" value="<%=(oStrategyDATA.getSell_all_deadline_min_toclose()!=null ? oStrategyDATA.getSell_all_deadline_min_toclose() : 0)%>"/>
