...
if (request.getParameter("pos_id_action")!=null) {  // hay operacion
	...
	Long RepeticionesTipo = Long.parseLong(request.getParameter("repeticionestipo"));
	Long Repeticiones = Long.parseLong(request.getParameter("repeticiones"));
	...
	{	
		...
		oRuleDATA.setBuy_limit_torepeat_same_share(RepeticionesTipo);
		oRuleDATA.setBuy_max_positionday_share(Repeticiones);
...
%>
    		...
    		<div>
    			<label class="flota_izq w200px textleft negrita" for="repeticionestipo">Repeticiones por tipo (BUY,SELL)*</label>
    			<input class="position fondo_blanco number mandatory flota_izq" type="text" id="repeticionestipo" name="repeticionestipo" value="<%=(oRuleDATA.getBuy_limit_torepeat_same_share()!=null ? oRuleDATA.getBuy_limit_torepeat_same_share() : "")%>">
    		</div>
    		<div>
    			<label class="flota_izq w200px textleft negrita" for="repeticiones">Repetición Dia (0 no aplica)*</label>
    			<input class="position fondo_blanco number mandatory flota_izq" type="text" id="repeticiones" name="repeticiones" value="<%=(oRuleDATA.getBuy_max_positionday_share()!=null ? oRuleDATA.getBuy_max_positionday_share() : "")%>">
    		</div>
