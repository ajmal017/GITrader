...
String _Type = ""; // [all, buy, sell]
Integer  _DisableTrading = 0; // [all, buy, sell]
...
if (request.getParameter("typeoperation")!=null)
	_Type = request.getParameter("typeoperation");
if (request.getParameter("disabletrd")!=null && request.getParameter("disabletrd")!="")
	_DisableTrading = 1;
...
for (int j=0;j<aStrategy.length;j++)
{
	...
	{	
		if (_Action.equals("start"))
		{
			...
			oStrategy.setSell_all_deadline_type_operation(_Type);
			oStrategy.setSell_all_deadline_deactivate_trading(_DisableTrading);
	...
	out.println("OK. Configuración guardada correctamente. No altere la configuración durante el proceso..");
